...
public class HueFilter extends BaseFilter {
    ...
    private static final String TAG = HueFilter.class.getSimpleName();
    ...
    private float[] mChangeColor;

    public HueFilter(float[] changeColor) {
    ...
    public void onDraw(int textureId, float[] matrix) {
        ...
        // 写入改变色值
        GLES20.glUniform3f(vChangeColorHandle, mChangeColor[0], mChangeColor[1], mChangeColor[2]);
